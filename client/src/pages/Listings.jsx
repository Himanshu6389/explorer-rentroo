...
const Listings = () => {
  ...
  const currency = "$"
  const [searchQuery, setSearchQuery] = useState("") // Temporary - we will get this state {with usecontext hook} from header component
          ...
          <div className='max-sm:px-10 sm:pr-10 bg-white p-4 rounded-l-xl my-4'>
            ...
            <div className='flexCenter flex flex-wrap mt-14 mb-10 gap-3'>
              ...
              {Array.from({length: totalPages}, (_ , index)=>(
                <button key={index + 1} onClick={()=>setCurrPage(index + 1)} className={`btn-outline h-8 w-8 p-0 flexCenter ${
